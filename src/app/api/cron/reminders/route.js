...
export async function GET(req) {
  ...
  try {
    ...
    if (!teAlertes) {
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
              <thead>
                <tr style="color: #8A9BB0; text-align: left; font-size: 12px; border-bottom: 1px solid #1E3050;">
                  ...
                  <th style="padding: 6px 8px; text-align: center;">Data Límit</th>
                  <th style="padding: 6px 8px; text-align: right;">Estat</th>
                </tr>
              </thead>
              <tbody>
                ${rows}
      ...
      htmlContent += renderTaula('Despensa i Provisions', '🥫', caducitatsDespensa, 'nombre');
    ...
    if (!brevoKey || !destí) {
      ...
      return new Response(JSON.stringify({ 
        ...
        alertes: {
          ...
          despensa: caducitatsDespensa.length,
